...
<html lang="en">
    <head>
        ...
        <title>IJburg College - Badge uitreiken</title>
    ...
    <body>
        ...
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="badgeUit.php">Badge uitreiken</a></li>
                <li><a href="badgeTerug.php">Badge terugtrekken</a></li>
            ...
            <form action="<?php $_PHP_SELF ?>" method="post">
                <div class="leftpanel">
                    ...
                    if ($klas_post) {
                        ...
                        #Badge
                        $sql_badge = "SELECT badgenaam, badgenr FROM Badge ORDER BY badgenr ASC";
                        ...
                        if ($badge_post && $leerling_post){
                            ...
                            echo '<br><br>Succesvol badge toegewezen aan' . $naamLeerling['voornaam'] . ' ' . $naamLeerling['achternaam'];
                        }
                    } else {
                        $sql_klas = "SELECT klasnaam FROM Klas";
                        $klas = mysql_query($sql_klas);
